...
<p align="left">Я начинающий Python разработчик и мне интересны такие темы, как Большие языкыкое модели(LLM), создание AI-агентов и процессы, связанные с обработкой естественного языка (NLP). Я учусь в ВУЗе МГТУ им. Н.Э Баумана на направлении "инноватика".
За последние несколько лет я прошел множество курсов, таких как
  
<li>
ML-разработчик на Цифровой кафедре при МГТУ, 
разработка на Python и Алгоритмы от яндекс практикум,
применение Pandas от Kaggle 
</li>

и прочитал множество книг и документации на тему LLM и NLP, например
</p>
